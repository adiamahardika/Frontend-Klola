...
class AdminSidenav extends Component {
  ...
  filterProduct = (event) => {
    ...
    this.props.history.push(
      `/adminproduct?sortBy=${this.state.sortBy}&orderBy=${this.state.orderBy}&name=${this.state.name}&category=${event}&page=${this.state.page}`
    );
    this.props.dispatch(
      modifyProduct(
        this.state.sortBy,
  ...
  sortProduct = (event) => {
    ...
    this.props.history.push(
      `/adminproduct?sortBy=${event.target.value}&orderBy=${this.state.orderBy}&name=${this.state.name}&category=${this.props.category}&page=${this.state.page}`
    );
  ...
  orderProduct = (event) => {
    ...
    this.props.history.push(
      `/adminproduct?sortBy=${this.state.sortBy}&orderBy=${event.target.value}&name=${this.state.name}&category=${this.props.category}&page=${this.state.page}`
    );
              ...
              <div className="col">
                <div className="p-3">
                  <div class="btn-group dropright" style={{ display: "block" }}>
                    ...
                    <div class="dropdown-menu">
                      ...
                      {categories.map((category, index) => (
                        <button
                          onClick={() => this.filterProduct(category.id)}
                          class="dropdown-item"
                          key={index}
                          value={category.id}
                        >
                  ...
                  >
                    ...
                    <div class="dropdown-menu">
                      <button
                        onClick={this.onShowAddProduct}
                        class="dropdown-item"
                      >
                        Add Product
                      </button>
                      <button
                        onClick={this.onShowAddCategory}
                        class="dropdown-item"
                      >
                        Add Category
                      </button>
                  ...
                  <AddProduct
                    ...
                    onHide={this.onCloseAddProduct}
                  />
                  <AddCategory
                    show={this.state.showAddCategory}
                    onHide={this.onCloseAddCategory}
                  />
                  <AddUser
                    show={this.state.showAddUser}
                    onHide={this.onCloseAddUser}
                  />
                </div>
              </div>
            </NavIcon>
